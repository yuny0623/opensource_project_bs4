...
***
set_of_word 에 대한 설명 아직 안써놨음. 이거 나중에 써주기. 

2020.11.03
그리고 전반적으로 보완해야 할거.... 는 뭐가 있지.... 음. ..
soup객체로 받아온거 text화하고, split하는데, parser를 만들기로 했는데, 동사 명사 이런거 분류하는게 생각보다 어려움. 그리고 set_of_word.py는 영어밖에 지원이 안됨. 
객체 받아온게 좀더 활용이 되야하는데, 정리가 좀 덜된 느낌? 음... 그래서 .... 
